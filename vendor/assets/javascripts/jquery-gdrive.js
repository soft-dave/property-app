(function($) {
	...
	var gopts = {
		...
		'appid': null,
		'user': null,
		'scope': 'https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/photos',
		'authtok': null,
		'init_stage': 0,
		'width': 800,
		'height': 400,
	...
	function show_dlg(target_id) {
		...
		var view = new google.picker.DocsView(google.picker.ViewId.PHOTO_ALBUMS);
